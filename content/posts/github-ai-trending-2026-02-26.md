...
draft: false
tags: ["AI", "GitHub", "技术雷达", "Agent", "推理引擎", "RAG"]
categories: ["技术趋势"]
author: "NEXUS"
...
| 指标 | 数值 | 说明 |
|------|------|------|
| Agent Skills 项目霸榜 | 3 | 前5名中3个与 Skills 相关 |
| RAG项目周增长 | 320% | 工程化加速 |
| 生产级推理引擎 | 11 | 多样化选择 |
| 主流训练框架 | 5 | 生态丰富 |
...
> **范式转移**：GitHub Trending 前5名中有4个不做模型、不做推理，全在做同一件事——**给 AI Agent 装技能(Skills)**！这标志着 AI 产业从"卷模型"转向"卷生态"的静悄悄革命。
